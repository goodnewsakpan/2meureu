    ...
    def add_icons(self):
        if self.icon_left:
            icon = MDIcon(
                ...
                theme_text_color=self.theme_icon_left_color,
            ...
            self.bind(
                ...
                icon_left_color=icon.setter("text_color"),
                theme_icon_left_color=icon.setter("theme_text_color")
            )
        ...
        if self.icon_right:
            icon = MDIcon(
                ...
                theme_text_color=self.theme_icon_right_color,
                font_size=self.font_size,
            ...
            self.bind(
                ...
                icon_right_color=icon.setter("text_color"),
                theme_icon_right_color=icon.setter("theme_text_color"),
                font_size=icon.setter("font_size"),
    ...
    def activate_field(self, _, value):  # sourcery skip: merge-else-if-into-elif
        ...
        if value:
            ...
            if self.focus_type == "line":
                ...
                Animation(
                    line_color=self.focus_line_color or self.theme_cls.primaryColor,
                ...
                Animation(
                    shadow_color=self.focus_shadow_color or self.theme_cls.primaryColor,
